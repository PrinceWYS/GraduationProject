...
class Location:
    ...
    def OnLocationResultReturn(self, result, isResponse):
        ...
        self.tum = result['requestTimestamp'] + " " + str(result['x']) + " " + str(result['y']) + " " + str(
    ...
    def RequestLocateNewApi(self, requestData, callback):
        ...
        if sys.argv[1] == 'test':
            headers["Request-Timestamp"] = self.GetTimeStamp1970()
...
if __name__ == '__main__':
    ...
    while True:
        if sys.argv[1] == 'test':
            ...
            if sys.argv[2] == 'left':
                Location().RequestOnceLocation('/home/cvg/Downloads/location/left.jpg')
            elif sys.argv[2] == 'front':
                Location().RequestOnceLocation('/home/cvg/Downloads/location/front.jpg')
            elif sys.argv[2] == 'right':
                Location().RequestOnceLocation('/home/cvg/Downloads/location/right.jpg')
            # Location().RequestOnceLocation('/home/cvg/Downloads/location/testPic.JPG')
        elif sys.argv[1] == 'run':
            timeList = Camera().capture()
            for t in timeList:
